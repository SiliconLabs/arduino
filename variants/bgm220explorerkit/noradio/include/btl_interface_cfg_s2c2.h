 ...
 *
 ******************************************************************************/
#ifndef BTL_INTERFACE_CFG_S2C2_H
#define BTL_INTERFACE_CFG_S2C2_H
...
// <q> DCI
// <i> Update secure access state of DCI before calling into bootloader
#define BOOTLOADER_PPUSATD0_DCI 0

// <q> DCDC
// <i> Update secure access state of DCDC before calling into bootloader
#define BOOTLOADER_PPUSATD1_DCDC 0

// <q> PDM
// <i> Update secure access state of PDM before calling into bootloader
#define BOOTLOADER_PPUSATD1_PDM 0

// <q> RFSENSE
// <i> Update secure access state of RFSENSE before calling into bootloader
#define BOOTLOADER_PPUSATD1_RFSENSE 0
...
#define BOOTLOADER_PPUSATD1_RTCC 0
...
// <q> EUART0
// <i> Update secure access state of EUART0 before calling into bootloader
#define BOOTLOADER_PPUSATD1_EUART0 0

// <q> CRYPTOACC
// <i> Update secure access state of CRYPTOACC before calling into bootloader
#define BOOTLOADER_PPUSATD1_CRYPTOACC 0
...
#define BOOTLOADER_PPUSATD0_MASK ((BOOTLOADER_PPUSATD0_EMU << _SMU_PPUSATD0_EMU_SHIFT) \
                                   ...
                                   | (BOOTLOADER_PPUSATD0_DCI << _SMU_PPUSATD0_DCI_SHIFT))
#define BOOTLOADER_PPUSATD1_MASK ((BOOTLOADER_PPUSATD1_DCDC << _SMU_PPUSATD1_DCDC_SHIFT) \
                                   | (BOOTLOADER_PPUSATD1_PDM << _SMU_PPUSATD1_PDM_SHIFT) \
                                   | (BOOTLOADER_PPUSATD1_RFSENSE << _SMU_PPUSATD1_RFSENSE_SHIFT) \
                                   ...
                                   | (BOOTLOADER_PPUSATD1_RTCC << _SMU_PPUSATD1_RTCC_SHIFT) \
                                   ...
                                   | (BOOTLOADER_PPUSATD1_EUART0 << _SMU_PPUSATD1_EUART0_SHIFT) \
                                   | (BOOTLOADER_PPUSATD1_CRYPTOACC << _SMU_PPUSATD1_CRYPTOACC_SHIFT) \
                                   | (BOOTLOADER_PPUSATD1_AHBRADIO << _SMU_PPUSATD1_AHBRADIO_SHIFT))
#endif // BOOTLOADER_MANUAL_OVERRIDE_SECURITY_STATE

#endif // BTL_INTERFACE_CFG_S2C2_H
