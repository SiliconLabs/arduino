...
// EUSART0 TX on PB01
#define SL_SPIDRV_EUSART_NANOMATTER1_TX_PORT       gpioPortB
#define SL_SPIDRV_EUSART_NANOMATTER1_TX_PIN        0

// EUSART0 RX on PB02
#define SL_SPIDRV_EUSART_NANOMATTER1_RX_PORT       gpioPortB
#define SL_SPIDRV_EUSART_NANOMATTER1_RX_PIN        2

// EUSART0 SCLK on PB00
#define SL_SPIDRV_EUSART_NANOMATTER1_SCLK_PORT     gpioPortB
#define SL_SPIDRV_EUSART_NANOMATTER1_SCLK_PIN      5
