...
#define SL_I2CSPM_NANOMATTER_PRESENT
#define SL_I2CSPM_NANOMATTER1_PRESENT


extern sl_i2cspm_t *sl_i2cspm_nanomatter;
extern sl_i2cspm_t *sl_i2cspm_nanomatter1;
