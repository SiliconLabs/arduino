...
#define SL_SPIDRV_USART_MIKROE_CS_CONTROL        spidrvCsControlApplication
...
// USART0 TX on PC00
#define SL_SPIDRV_USART_MIKROE_TX_PORT           SL_GPIO_PORT_C
#define SL_SPIDRV_USART_MIKROE_TX_PIN            0

// USART0 RX on PC01
#define SL_SPIDRV_USART_MIKROE_RX_PORT           SL_GPIO_PORT_C
#define SL_SPIDRV_USART_MIKROE_RX_PIN            1

// USART0 CLK on PC02
#define SL_SPIDRV_USART_MIKROE_CLK_PORT          SL_GPIO_PORT_C
#define SL_SPIDRV_USART_MIKROE_CLK_PIN           2

// USART0 CS on PC03
#define SL_SPIDRV_USART_MIKROE_CS_PORT           SL_GPIO_PORT_C
